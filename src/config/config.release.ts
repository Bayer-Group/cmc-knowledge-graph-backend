...
export const configqa: ConfigFile = {
    app: {
        port: 8080,
    ...
    tripleStores: {
      ...
      KGEConfigDB: {
        host: 'backbone-alb-1447214507.eu-central-1.elb.amazonaws.com',
        protocol: 'https',
        serviceHost: 'backbone-alb-1447214507.eu-central-1.elb.amazonaws.com',
        port: 5821,
